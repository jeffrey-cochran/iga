from impeller_patches import ImpellerPatches
    ...
    def __init__(self,
        ...
        *,
        ...
        for i in range(num_impellers-1,-1,-1):
            ...
            impeller_translation+=translation
            ip = ImpellerPatches(
            ...
            shaft_translation=translation+asarray([0,0,accumulated_z_translation])
            sp = ShaftPatches(
                translation=shaft_translation,
